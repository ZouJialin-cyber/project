...
def process_mask_main():
    # 图像分类的mask路径
    original_folder = r"/storeData/USER/data/01.CellBin/00.user/zoujialin/MobileNetV3-master/process_3/predict_mini4_process_mask/class_mask"
    # 新文件夹路径, 转换为最小外接矩形的mask
    new_folder = r"/storeData/USER/data/01.CellBin/00.user/zoujialin/MobileNetV3-master/process_3/predict_mini4_process_mask/process_mask"
