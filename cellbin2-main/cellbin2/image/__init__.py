...
if __name__ == '__main__':
    image_file_path = r"C:\Users\zoujialin\Desktop\gold\demo\B04272D4\image\B04272D4_img.png"
    cbi_image = CBImage(image_file_path)
    ...
    new_cbi_image = cbi_image.trans_image(
        scale=(1 / ScaleX, 1 / ScaleY),
        rotate=-Rotation,
        rot90=CounterRot90,
        offset=(OffsetX, OffsetY),
        flip_lr=Flip,
        dst_size= (23520, 23520)    # h * w
    )

    output_path = r"C:\Users\zoujialin\Desktop\gold\demo\B04272D4\our_track_merge\png_regist.png"
    new_cbi_image.write(output_path)    # cv.imwrite(output_path, new_cbi_image.image)